...
(function () {
  ...
  forms.forEach(function (e) {
    const loadingElement = e.querySelector('.loading');
    const errorMessageElement = e.querySelector('.error-message');
    const sentMessageElement = e.querySelector('.sent-message');
    ...
    e.addEventListener('submit', function (event) {
      ...
      // Show loading spinner and hide success/error messages
  ...
  function submitForm(thisForm, action, formData) {
    fetch(action, {
      ...
      .then(data => {
        ...
        // If the success flag in response is true
        if (data.success) {
          thisForm.querySelector('.sent-message').style.display = 'block';
          thisForm.querySelector('.sent-message').textContent = "Your message has been sent. Thank you!";
          thisForm.reset();  // Optional: reset form fields
        } else {
          thisForm.querySelector('.error-message').style.display = 'block';
          thisForm.querySelector('.error-message').textContent = "There was an issue with the form submission.";
        }
      })
      .catch((error) => {
        ...
        thisForm.querySelector('.loading').style.display = 'none';
        thisForm.querySelector('.error-message').style.display = 'block';
        thisForm.querySelector('.error-message').textContent = `Error: ${error.message || 'Something went wrong'}`;
      });
  }
